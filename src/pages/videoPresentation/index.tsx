...
const VideoPresentationsPage = () => {
  ...
  // Mock video abstracts
  const videoAbstracts: VideoAbstract[] = [
  {
    language: 'English',
    languageCode: 'en',
    flag: '🇺🇸',
    content: videosPresentations[currentVideoIndex]?.abstracts.en || ''
  },
  {
    language: 'Kiswahili',
    languageCode: 'sw',
    flag: '🇹🇿',
    content: videosPresentations[currentVideoIndex]?.abstracts.sw || ''
  },
  {
    language: 'Luganda',
    languageCode: 'lg',
    flag: '🇺🇬',
    content: videosPresentations[currentVideoIndex]?.abstracts.lg || ''
  }];
  ...
  const videoCategories: VideoCategory[] = [
  {
    ...
    name: 'All Videos',
    icon: 'Grid3X3',
    count: videosPresentations.length
  },
  {
    id: 'innovation',
    name: 'Innovation',
    icon: 'Lightbulb',
    count: videosPresentations.filter((v) => v.category === 'innovation').length
  },
  {
    id: 'culture',
    name: 'Culture',
    icon: 'Users',
    count: videosPresentations.filter((v) => v.category === 'culture').length
  },
  {
    id: 'society',
    name: 'Society',
    icon: 'Globe',
    count: videosPresentations.filter((v) => v.category === 'society').length
  },
  {
    id: 'research',
    name: 'Research',
    icon: 'Search',
    count: videosPresentations.filter((v) => v.category === 'research').length
  }];
  ...
  videosPresentations :
  videosPresentations.filter((video) => video.category === selectedCategory);
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Video Presentations - Student Portfolio Capstone</title>
        <meta name="description" content="Watch comprehensive academic video presentations with multilingual abstracts covering innovation, culture, society, and research topics." />
      </Helmet>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground font-caption">
                  Academic presentations with multilingual abstracts
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-foreground">
                    {Math.floor(videosPresentations.reduce((acc, v) => acc + v.duration, 0) / 60)} minutes
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-muted-foreground">Total Views</span>
                  <span className="font-medium text-foreground">
                    {videosPresentations.reduce((acc, v) => acc + v.views, 0).toLocaleString()}
                  </span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-card border border-border rounded-lg p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-3">
                  <span className="text-lg">🇺🇬</span>
                  <span className="text-foreground">Luganda</span>
                </div>
              </div>
            </div>
