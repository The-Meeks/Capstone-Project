...
import {
  ...
  RecentActivity as RecentActivityType } from
'./types';
...
const StudentDashboard = () => {
  ...
  const studentProfile: StudentProfile = {
    ...
    profileImage: "https://img.rocket.new/generatedImages/rocket_gen_img_1c5746a0d-1762273807933.png",
    profileImageAlt: "Professional headshot of young African woman with braided hair wearing blue blazer, smiling confidently at camera",
    skills: [
  ...
  const portfolioProgress: PortfolioProgressType = {
    ...
    },
    {
      ...
      isCompleted: false,
      progress: 75,
      lastUpdated: new Date(Date.now() - 604800000) // 7 days ago
    },
    {
      id: "challenges",
      name: "Modern Society Challenges",
      isCompleted: false,
      progress: 60,
      lastUpdated: new Date(Date.now() - 691200000) // 8 days ago
    }]
  ...
  const recentActivities: RecentActivityType[] = [
  {
    ...
    description: "Uploaded final slides for technology innovation showcase presentation",
  ...
  },
  {
    ...
    description: "Updated skills section and added recent project experience",
  ...
  },
  {
    ...
    description: "Reviewed portfolio performance metrics and visitor engagement",
  ...
  },
  {
    ...
    description: "Shared cultural preservation video with academic review committee",
  ...
  },
  {
    id: "5",
    type: "upload",
    title: "Photo Essay Collection",
    description: "Added new images to community development photographic essay",
